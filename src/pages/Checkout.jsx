...
import { removeFromCart } from "../redux/cartSlice"; // Action
        ...
        <>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4 items-center justify-around flex flex-row">
              ...
              <button className="w-12 h-12 border-4 border-s-amber-500 bg-blue-500 text-white text-3xl p-4 rounded-full flex items-center justify-center">
                <i className="fa-brands fa-google-pay"></i>
              </button>
              <button className="w-12 font-bold h-12 border-2 border-gray-500 bg-purple-600 rounded-full text-white py-2 rounded flex items-center justify-center">
               Pe</button>
               </div>
...
export default Checkout; // Export
